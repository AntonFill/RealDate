...
- [ ] **custom new filename format (--new-format)** - Eigenes Date-Format beim Verändern des Dateinames "yyyy.MM.dd"
...
- [x] **Rename Mode (--rename)** - Timestamp setzen und Dateinamen ändern ✓
